...
public class ProcessAvatar {
    ...
    public List<ProcessAvatarIndex> getIndexes() {
        return this.indexes;
    }


    public AtomicReference<ProcessAvatarStatus> getStatus() {
        return this.status;
    }


    public AtomicReference<String> getExternalMessage() {
        return this.externalMessage;
    }


    public AtomicReference<Instant> getLastModified() {
        return this.lastModified;
    }


    public AtomicReference<String> getCurrentStep() {
    ...
    public AtomicReference<ChainOutput> getPreviousOutput() {
        return this.previousOutput;
    }


    public AtomicReference<OutputMetadata<?>> getPreviousOutputMetadata() {
        return this.previousOutputMetadata;
    }
